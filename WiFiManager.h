...
const char HTTP_STYLE[] PROGMEM           = "<style>.c{text-align: center;} .pasafficher{display:none;} div,input{padding:5px;font-size:1em;} input{width:95%;} body{text-align: center;font-family:verdana;} button{border:0;border-radius:0.3rem;background-color:#1fa3ec;color:#fff;line-height:2.4rem;font-size:1.2rem;width:100%;} .q{float: right;width: 64px;text-align: right;} .l{background: url(\"data:image/png;base64,\") no-repeat left center;background-size: 1em;}</style>";
...
const char HTTP_PORTAL_OPTIONS[] PROGMEM  = "<form action=\"/wifi\" method=\"get\"><button>STEP 2 : Configure Wifi</button></form><br/><form action=\"/0wifi\" method=\"get\"><button class="pasafficher">Configure WiFi (No Scan)</button></form><br/><form action=\"/i\" method=\"get\"><button class="pasafficher">Info</button></form><br/><form action=\"/r\" method=\"post\"><button class="pasafficher">Reset</button></form>";
